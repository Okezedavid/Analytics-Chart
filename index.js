...
themeColorButtons.forEach(themeColorButton => {
    themeColorButton.addEventListener('click', (e) => {
        ...
        if(currentTheme === darkTheme) {
            ...
            headerDiv.style.backgroundColor = '#2c2c2c';
            headerContainer.style.backgroundColor = '#2c2c2c';
            whiteBgElements.forEach(whiteBgElement => {
                whiteBgElement.style.backgroundColor = '#2c2c2c'
            });
            themeColorContainer.style.backgroundColor = '#2c2c2c';
            userNameDetail.style.backgroundColor = '#2c2c2c';
        } 
    })
});
//